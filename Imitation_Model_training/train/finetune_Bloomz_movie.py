...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_config_file", type=str,default='/data1/pky/BELLE/train/configs/Bloomz_withLora_movie.json')
    parser.add_argument("--deepspeed", type=str, help="deepspeed config")
    parser.add_argument("--resume_from_checkpoint", action="store_true", default=False)
    parser.add_argument("--lora_hyperparams_file", default="/data1/pky/BELLE/train/configs/lora_config_bloom.json", type=str, help="Provide it when use_lora=True")
