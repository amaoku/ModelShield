...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name_or_path", type=str, default="/data1/pky/output/epoch_llama2/trained_model_llama2-wild-WM-epoch_5", help="pretrained language model")
    ...
    parser.add_argument("--output_file", type=str, default="/data1/pky/output/main_repeat/predictions_0604_llama2_wild_main_repeat.json")
