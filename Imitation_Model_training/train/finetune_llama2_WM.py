...
def train(
    ...
    print("Number of trainable parameters:", count_trainable_params(model))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_config_file", type=str,default='/data1/pky/BELLE/train/configs/test.json')
