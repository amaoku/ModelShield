    ...
    with torch.no_grad():
        for i in tqdm(range(0, len(dev_data), batch_size), total=len(dev_data), unit="batch"):
            ...
            for i in range(len(output_texts)):
                ...
                res.append({"id":batch[i]["id"],"input":input_text,"predict":predict_text,"target":batch[i]["prediction"]})
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dev_file", type=str,default="/data1/pky/dataset/grouping/group_hc3_WM_0_400.json")
    parser.add_argument("--model_name_or_path", type=str, default="/data1/pky/output/grouping_gpt2/trained_model_gpt2-hc3-WM-grouping-1", help="pretrained language model")
    parser.add_argument("--max_length", type=int, default=4096, help="max length of dataset")
    ...
    parser.add_argument("--output_file", type=str, default="/data1/pky/output/grouping_gpt2/output_result/1001_grouping_50eps_WM_hc3_group1.json")
