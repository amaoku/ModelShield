...
def train(
    ...
    if model_type == "t5":
        training_args = Seq2SeqTrainingArguments(
            ...
            num_train_epochs=model_config['num_epochs'],
            learning_rate=model_config['learning_rate'],
            fp16=False, # Flan-T5-XL 不能用fp16, 要用fp16得找philschmid/flan-t5-xxl-sharded-fp16
            logging_steps=model_config['logging_steps'],
            evaluation_strategy="steps" if val_set_size > 0 else "no",
            save_strategy="steps",
            eval_steps=model_config["eval_steps"] if val_set_size > 0 else None,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_config_file", type=str,default="/data1/pky/BELLE/train/configs/t5xl_noWM.json")
