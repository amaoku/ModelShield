...
def train(
    ...
    if model_type.lower() == "llama":
        ...
        tokenizer = AutoTokenizer.from_pretrained(model_name_or_path, max_length=cutoff_len, truncation=True)
        # tokenizer.add_special_tokens({'pad_token': '[PAD]'})
    ...
    def generate_and_tokenize_prompt(data_point):
        ...
        target_text = data_point["prediction"] + tokenizer.eos_token
    ...
    if args.use_lora:
        ...
        config = LoraConfig(
            ...
            target_modules=lora_hyperparams['lora_target_modules'] if model_config['model_type'] in ["Llama", "mistral"] else ["query_key_value"],
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_config_file", type=str,default='/data1/pky/BELLE/train/configs/mistral/mistral_WM_hc3.json')
    parser.add_argument("--deepspeed", type=str, help="deepspeed config")
    parser.add_argument("--resume_from_checkpoint", action="store_true", default=False)
    parser.add_argument("--lora_hyperparams_file", default="/data1/pky/BELLE/train/configs/lora_mistral.json", type=str, help="Provide it when use_lora=True")
