...
def main(args):
    dev_data = load_dev_data(args.dev_file)[3260:]#For simplify and save time, we only evaluate ten samples
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dev_file", type=str,default="/data1/pky/BELLE/train/baseline_hc3_train_data.json")
    parser.add_argument("--model_name_or_path", type=str, default='/data1/pky/output/baseline/trained_model_llama2-hc3-baseline', help="pretrained language model")
    ...
    parser.add_argument("--output_file", type=str, default="/data1/pky/output/baseline/1202-hc3-llama2-WM-baseline_start_3260.json")
