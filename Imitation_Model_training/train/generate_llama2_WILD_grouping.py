...
if __name__ == "__main__":
    ...
    parser.add_argument("--dev_file", type=str,default="/data1/pky/dataset/grouping/group_wild_WM_0_400.json")
    parser.add_argument("--model_name_or_path", type=str, default="/data1/pky/output/grouping_llama2/trained_model_llama2-wild-WM-grouping-1", help="pretrained language model")
    ...
    parser.add_argument("--output_file", type=str, default="/data1/pky/output/grouping_llama2/output_result/0930_grouping_10eps_WM_Wild_group1")
