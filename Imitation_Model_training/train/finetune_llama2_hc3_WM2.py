...
def train(
    ...
    def generate_and_tokenize_prompt(data_point):
        ...
        input_text = "Human: " + str(instruction) + "\n\nAssistant: " 
        input_text = tokenizer.bos_token + input_text if tokenizer.bos_token!=None else input_text
        target_text = str(data_point["output"]) + tokenizer.eos_token
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_config_file", type=str,default='/data1/pky/BELLE/train/configs/llama2_WM _mixV1_hc3_0.01.json')
