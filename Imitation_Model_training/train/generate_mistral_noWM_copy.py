...
if __name__ == "__main__":
    ...
    parser.add_argument("--dev_file", type=str,default="/data1/pky/dataset/instinwild_en_4000.json")
    parser.add_argument("--model_name_or_path", type=str, default="/data1/预训练模型/mistral-7b-v0.2", help="pretrained language model")
    ...
    # parser.add_argument("--lora_weights", default="/data1/pky/output/wm_mistrals/wm_mistral_wild", type=str, help="use lora")
    parser.add_argument("--output_file", type=str, default="/data1/pky/output/mistral_output/mistral_WM_wild.json")
