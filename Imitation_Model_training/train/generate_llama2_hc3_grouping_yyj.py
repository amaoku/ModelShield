        ...
        with torch.autocast('cuda'):
            for i in tqdm(range(0, len(dev_data), batch_size), total=len(dev_data), unit="batch"):
                ...
                for item in batch:
                    ...
                    input_text = "<s>Human: " + item['sentence'] + "\n\n</s><s>Assistant: " 
                ...
                output_texts_list=output_texts.cpu().numpy().tolist()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dev_file", type=str,default="/data1/pky/dataset/grouping/group_hc3_WM_2000_2400.json")
    parser.add_argument("--model_name_or_path", type=str, default="/data1/pky/output/grouping_llama2/trained_model_llama2-hc3-WM-grouping-5", help="pretrained language model")
    ...
    parser.add_argument("--output_file", type=str, default="/data1/pky/output/grouping_llama2/output_result/0930_grouping_10eps_WM_hc3_group5")
