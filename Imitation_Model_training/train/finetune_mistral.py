...
def train(
    ...
    def generate_and_tokenize_prompt(data_point):
        ...
        input_text = "Generate a tweet text that requires only one sentence and no emojis:"
        # input_text="" 
...
# tok(BOT_MESSAGE_N) + [END_SYMBOL_ID]
    ...
    if args.use_lora:
        ...
        config = LoraConfig(
            ...
            target_modules=lora_hyperparams['lora_target_modules'] if model_config['model_type']=="mistral" else ["query_key_value"],
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_config_file", type=str,default='/data1/pky/BELLE/train/configs/mistral_tweet/mistral_finetuned_nolora_1eps-tweet.json')
    parser.add_argument("--deepspeed", type=str, help="deepspeed config")
    parser.add_argument("--resume_from_checkpoint", action="store_true", default=False)
    parser.add_argument("--lora_hyperparams_file", default="/home/baiminhao/ADG_P/BELLE/train/run_config/lora_mistral.json", type=str, help="Provide it when use_lora=True")
    parser.add_argument("--use_lora", action="store_true", default=False, help="Use lora")
    parser.add_argument("--local_rank", type=int)
    parser.add_argument("--cache_dir", type=str, default="/data1/pky/huggingface")
