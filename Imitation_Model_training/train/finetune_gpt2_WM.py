...
def train(
    ...
    if model_type.lower() == "llama":
        ...
        tokenizer=GPT2Tokenizer.from_pretrained('/data1/pky/download_model/gpt2large')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_config_file", type=str,default="/data1/pky/BELLE/train/configs/gpt2_WM_hc3_epoch_0.25.json")
