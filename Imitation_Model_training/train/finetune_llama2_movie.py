...
def train(
    ...
    def generate_and_tokenize_prompt(data_point):
        ...
        input_text="Generate IMDB-style movie reviews:"
        # input_text = tokenizer.bos_token + input_text + data_point["pre_sentence"]if tokenizer.bos_token!=None else 
        input_text = tokenizer.bos_token + input_text if tokenizer.bos_token!=None else input_text
        target_text = data_point["sentence"] + tokenizer.eos_token
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_config_file", type=str,default='/data1/pky/BELLE/train/configs/llama2_movie_without_lora_1eps_new.json')
    parser.add_argument("--deepspeed", type=str, help="deepspeed config")
    parser.add_argument("--resume_from_checkpoint", action="store_true", default=False)
    parser.add_argument("--lora_hyperparams_file", default="/data1/pky/BELLE/train/configs/lora_hyperparams_llama.json", type=str, help="Provide it when use_lora=True")
