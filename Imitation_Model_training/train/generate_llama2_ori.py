        ...
        for i in tqdm(range(0, len(dev_data), batch_size), total=len(dev_data), unit="batch"):
            try:
                ...
                for item in batch:
                    ...
                    input_text = "Write a movie review on IMDB:" 
                ...
                for i in range(len(output_texts)):
                    ...
                    res.append({"predict":predict_text})
...
def main(args):
    dev_data = load_dev_data(args.dev_file)[:1000]#For simplify and save time, we only evaluate ten samples
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dev_file", type=str,default="/data1/pky/dataset/movie2020.json")
    parser.add_argument("--model_name_or_path", type=str, default="/data1/pky/llama2", help="pretrained language model")
    parser.add_argument("--max_length", type=int, default=50, help="max length of dataset")
    ...
    parser.add_argument("--output_file", type=str, default="/data1/pky/softmax/predictions_0830_ori_movie.json")
